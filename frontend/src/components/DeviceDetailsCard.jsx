...
export default function DeviceDetails({ ticket }) {
  const manufacture = {
    9779: "Lenovo",
    9776: "Asus",
    9778: "Compaq",
  ...
  return (
    <Card className="">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  <DeviceDetailsEdit ticket={ticket} />
                </DialogDescription>
              </DialogHeader>
              <DialogFooter className="sm:justify-center">
                <DialogClose asChild>
                  <Button
                    className="w-1/2	 text-white bg-green-600 hover:bg-green-800"
                    type="button"
                    variant="secondary"
                  >
                    Save
      ...
      <CardContent>
        {/* <div className="grid gap-4 grid-cols-1  min-w-80"> */}
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="font-medium">{replacedMake}</div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <ComputerIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
          ...
          <div className="flex items-center gap-2">
            <ShelfIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
            <div>
              <div className="text-sm text-gray-500 dark:text-gray-400">
                Location
              </div>
              <div className="font-medium">{ticket.properties.Bin}</div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <PasswordIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
            <div>
              <div className="text-sm text-gray-500 dark:text-gray-400">
                Password
              </div>
              <div className="font-medium">
                {/* {ticket.properties.Password} */}
                {isRevealed ? (
                  <>
                    <span>{ticket.properties.Password}</span>
                    <Progress
                      value={progress}
                  ...
                  <button onClick={handleClick}>Click to Reveal</button>
                )}
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="font-medium">{ticket.properties.Charger}</div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <CheckSquareIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
            <div>
              ...
              <div className="font-medium">{ticket.properties.Carrybag}</div>
            </div>
          </div>
          {/* <div className="flex items-center gap-2">
            <CheckSquareIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
