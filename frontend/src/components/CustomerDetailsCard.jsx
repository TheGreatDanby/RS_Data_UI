...
export default function CustomerDetailsCard({ customerData, customerId }) {
  ...
  if (error) return <div>Error loading customer details: {error.message}</div>;
  ...
  return (
    <Card>
      ...
      <CardContent>
        {/* <div className="grid gap-4 grid-cols-1 min-w-72"> */}
