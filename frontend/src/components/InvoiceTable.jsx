...
export default function InvoiceTable() {
  ...
  const editInvoice = (event, customerId) => {
    event.stopPropagation();
    navigate(`/invoices/edit/${customerId}`);
  };
  ...
  return (
    <div className="h-full min-h-screen min-w-40  p-5">
      ...
      <div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              ...
              <Button
                ...
                onClick={(event) => newInvoice(event)}
              >
                New Invoice
              </Button>
              <DropdownMenu>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="text-lg font-bold">INV #</TableHead>
                  ...
                  <TableHead className="text-lg font-bold">Paid</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {invoices.map((invoice, index) => (
                  ...
                  >
                    ...
                    <TableCell
                      className="font-semibold text-sky-500 hover:text-sky-700 cursor-pointer"
                      onClick={() => navigate(`/tickets/${invoice.ticket_id}`)}
                    >
                      {invoice.ticket_id ? "Ticket" : ""}
                    </TableCell>
                    ...
                    <TableCell>
                      <Button
                        ...
                        onClick={(event) => editTicket(event, invoice.id)}
                      >
                        {" "}
                        Edit
                      </Button>
        ...
        <h2 className="font-bold	">Total Invoices: {totalCount}</h2>
      </div>
    </div>
  );
}
